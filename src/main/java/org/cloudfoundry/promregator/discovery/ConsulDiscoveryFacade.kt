...
class ConsulDiscoveryFacade(
    ...
    fun consulServicesSingle(resp: HttpServletResponse, @PathVariable serviceName: String): Mono<List<ConsulService>> {
                    ...
                    .map { (hash, instance) ->
                        ConsulService(
                                ...
                                serviceMeta = mapOf(
                                        ...
                                        "cf_orgName" to (instance.target.originalTarget.orgName ?: ""),
                                        "cf_spaceName" to (instance.target.originalTarget.spaceName ?: ""),
