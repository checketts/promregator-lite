...
import com.github.promregator.config.EndpointConstants.ENDPOINT_PATH_PROMREGATOR_METRICS
...
class DiscoveryLabelV2(
    ...
    @get:JsonGetter("__metrics_path__") val metricsPath: String get() = targetPath
}
...
class DiscoveryControllerV2(
    ...
    fun discovery(request: HttpServletRequest) : List<DiscoveryV2Response> {
        return runBlocking {
            val instances = discoveryService.discoverCached()
